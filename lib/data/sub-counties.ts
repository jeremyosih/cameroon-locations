...
export const subCounties: SubCounty[] = [
  ...
  { code: "117", name: "Gatanga", county: "Murang" },
  ...
  { code: "118", name: "Kahuro", county: "Murang" },
  ...
  { code: "119", name: "Kandara", county: "Murang" },
  { code: "234", name: "Kanduyi", county: "Bungoma" },
  { code: "120", name: "Kangema", county: "Murang" },
  ...
  { code: "121", name: "Kigumo", county: "Murang" },
  { code: "122", name: "Kiharu", county: "Murang" },
  ...
  { code: "123", name: "Mathioya", county: "Murang" },
  ...
  { code: "124", name: "Murang", county: "Murang" },
